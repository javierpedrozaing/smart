class MateriasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @materia.save
        format.html { redirect_to @materia, notice: 'Materia se ha creado correctamente.' }
  ...
  def update
    respond_to do |format|
      if @materia.update(materia_params)
        format.html { redirect_to @materia, notice: 'Materia se actualizo correctamente.' }
  ...
  private
    ...
    def materia_params
      params.require(:materia).permit(:secciones_educativas_id, :descripcion)
    end
end
