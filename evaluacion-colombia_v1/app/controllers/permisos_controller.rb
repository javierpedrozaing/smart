class PermisosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @permiso.save
        format.html { redirect_to @permiso, notice: 'Permiso fue creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @permiso.update(permiso_params)
        format.html { redirect_to @permiso, notice: 'Permiso fue actualizado correctamente.' }
  ...
  def destroy
    @permiso.destroy
    respond_to do |format|
      format.html { redirect_to permisos_url, notice: 'Permiso fue eliminado correctamente.' }
  ...
  private
    ...
    def permiso_params
      params.require(:permiso).permit(:perfiles_id, :estados_id)
    end
end
