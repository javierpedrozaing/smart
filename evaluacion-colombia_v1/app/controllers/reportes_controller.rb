class ReportesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reporte.save
        format.html { redirect_to @reporte, notice: 'Reporte fue creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @reporte.update(reporte_params)
        format.html { redirect_to @reporte, notice: 'Reporte fue actualizado correctamente.' }
  ...
  def destroy
    @reporte.destroy
    respond_to do |format|
      format.html { redirect_to reportes_url, notice: 'Reporte fue eliminado correctamente.' }
  ...
  private
    ...
    def reporte_params
      params.require(:reporte).permit(:video_id, :tipos_reporte_id => [])
    end
end
